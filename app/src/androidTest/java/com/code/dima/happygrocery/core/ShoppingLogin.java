...
public class ShoppingLogin {
    ...
    // Scanning of Esselunga required
    ...
    public void shoppingLogin() {
                ...
                allOf(withId(R.id.phone_number), withText("339876"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText6.perform(scrollTo(), replaceText("3398761"));
                ...
                allOf(withId(R.id.phone_number), withText("3398761"),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                0)));
        textInputEditText8.perform(scrollTo(), replaceText("3398761494"));
        ...
        ViewInteraction viewGroup = onView(
                allOf(withId(R.id.DashboardPieChart),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction viewGroup2 = onView(
                allOf(withId(R.id.dashboard_empty_card_layout),
                        childAtPosition(
                                allOf(withId(R.id.dashboardCardView),
                                        childAtPosition(
                                                IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class),
                                                1)),
                                0),
