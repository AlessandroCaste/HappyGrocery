...
public class MultipleInserAndPayTest {

    // This test scans a shop, the barcodes of a pizza, swiffer and cola, updates the quantity of cola products and then ends
    @Rule
    ...
    @Test
    public void multipleInserAndPayTest() {
        ...
        ViewInteraction floatingActionButton10 = onView(
                allOf(withId(R.id.checkoutButton),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.drawer_layout),
                                        0),
